...
#define RTERM_SCROLLBAR_IMAGES           6
#endif
...
#define RTERM_DEFAULT_PRIVMODES (RTERM_PRIVMODE_AUTOWRAP | RTERM_PRIVMODE_VISIBLE_CURSOR | RTERM_PRIVMODE_SHIFT_SEQUENCES | RTERM_PRIVMODE_BACKSPACE | RTERM_PRIVMODE_SCROLLBAR)
...
struct R_termscrollbar {
    ...
    int              anchortop;
    int              anchorbottom;
#if (USE_IMLIB2) && (RTERM_SUPPORT_SCROLLBAR)
